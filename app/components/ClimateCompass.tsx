...
export function ClimateCompass() {
  return (
    <section className="py-16 md:py-24 lg:py-32 bg-gradient-to-br from-[#8B5A3C] to-[#A0613A]">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 max-w-7xl mx-auto">
          ...
          <motion.div
            ...
            className="bg-white/10 backdrop-blur-sm p-6 md:p-8 lg:p-10 rounded-sm"
          >
            <div className="text-[#F4C430] text-xs md:text-sm font-black tracking-wider mb-3 md:mb-4">CLIMATE IMPACT</div>
            ...
            <button className="text-white text-sm md:text-base font-semibold underline hover:no-underline transition-all">
              Access Compass →
            </button>
          </motion.div>
          ...
          <motion.div
            ...
            className="bg-white/10 backdrop-blur-sm p-6 md:p-8 lg:p-10 rounded-sm"
          >
            <div className="text-[#F4C430] text-xs md:text-sm font-black tracking-wider mb-3 md:mb-4">RESEARCH REPORT</div>
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-black text-white mb-4 md:mb-6">
              NEW RESEARCH<br />
