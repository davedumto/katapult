  ...
  useEffect(() => {
    ...
    const handleWheel = (e: WheelEvent) => {
      ...
      if (isInViewport) {
        ...
        const slowedDelta = e.deltaY * 0.3;
    ...
    const handleTouchStart = (e: TouchEvent) => {
      ...
      if (isInViewport) {
        (section as any)._touchStartY = e.touches[0].clientY;
      }
    };
    ...
    const handleTouchMove = (e: TouchEvent) => {
      ...
      if (isInViewport && (section as any)._touchStartY) {
        e.preventDefault();
        
        const touchDelta = (section as any)._touchStartY - e.touches[0].clientY;
        const slowedDelta = touchDelta * 0.3;
